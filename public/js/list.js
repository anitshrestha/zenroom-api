var Hotel = {
    ...
    getDateListing: function() {
        Hotel.updateUi(HotelContainer.xhrLink + '?date=' + $(this).data('date'));
    },
...
$(document).ready(function() {
    ...
    $('form.store-details').validate(Hotel.validationRule());
    
    //Table Navigation
    $('.page-navigation .btn-arrow.right').on('click', Hotel.moveRight);
    $('.page-navigation .btn-arrow.left').on('click', Hotel.moveLeft);

    //Ajax Operations
    $('body').on('click', '.date-holder', Hotel.getDateListing);
    $('form.store-details').on('submit', Hotel.updateRoomDetails);
});
